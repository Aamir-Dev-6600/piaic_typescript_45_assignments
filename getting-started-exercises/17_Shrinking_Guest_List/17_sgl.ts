...
while(guests.length > 2) {
    console.log(`Sorry ${guests.pop()}, change of plans. Let us send you another invitation soon, the dinner for sunday is cancelled.`);
}
...
console.log(`No elements on the list - List length: ${guests.length}`); 
