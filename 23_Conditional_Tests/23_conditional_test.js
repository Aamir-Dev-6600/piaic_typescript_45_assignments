...
var wrongValues = ['Nitro 54', 'Oppo', true, true, 'Hd'];
var mobile = {
...
Object.entries(mobile).forEach(function (_a) {
    var key = _a[0], value = _a[1];
    console.log("Is ".concat(key, " == '").concat(value, "' ? I predict Ture."));
    console.log(mobile[key] == value);
});
console.log('\n\n');
// iterate over the object entries [(key, value), (key, value), /* rest of key values **/]
// every time, print the prompt with key value and compare the value at key with wrongValues
Object.entries(mobile).forEach(function (_a, index) {
    var key = _a[0], value = _a[1];
    console.log("Is ".concat(key, " == '").concat(wrongValues[index], "' ? I predict False."));
